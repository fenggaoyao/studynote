var ElementPlusButton = (function (exports, vue) {
  'use strict';
  ...
  var script = vue.defineComponent({
    ...
    setup(props, ctx) {
      ...
      const elFormItemSize_ = vue.computed(() => {
  ...
  script$1.__file = "packages/button/src/button-group.vue";
...
var ElementPlusLayout = (function (vue) {
  'use strict';
...
var ElementPlusTree = (function (vue) {
  'use strict';
  ...
  function objectAssign(target, ...agrvs) {
  ...
  const useCheckboxGroup = () => {
    ...
    const elFormItemSize = vue.computed(() => {
      return elFormItem === null || elFormItem === void 0 ? void 0 : elFormItem.elFormItemSize;
    });
    return {
      isGroup,
      checkboxGroup,
  ...
  const useModel = (props) => {
    ...
    const store = vue.computed(() => {
      var _a;
      return checkboxGroup ? (_a = checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.modelValue) === null || _a === void 0 ? void 0 : _a.value : props.modelValue;
    });
    const model = vue.computed({
      ...
      set(val) {
        ...
        if (isGroup.value && Array.isArray(val)) {
          ...
          if ((checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.min) !== undefined && val.length < (checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.min.value)) {
            isLimitExceeded.value = true;
          }
          if ((checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.max) !== undefined && val.length > (checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.max.value)) {
            isLimitExceeded.value = true;
          }
  ...
  const useCheckboxStatus = (props, {
    ...
    const size = vue.computed(() => {
      var _a;
      return ((_a = checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.checkboxGroupSize) === null || _a === void 0 ? void 0 : _a.value) || elFormItemSize.value || (ELEMENT === null || ELEMENT === void 0 ? void 0 : ELEMENT.size);
    });
    ...
    const checkboxSize = vue.computed(() => {
      var _a;
      const temCheckboxSize = props.size || elFormItemSize.value || (ELEMENT === null || ELEMENT === void 0 ? void 0 : ELEMENT.size);
      return isGroup.value ?
  ...
  const useDisabled = (props, {
    ...
    const isLimitDisabled = vue.computed(() => {
      var _a, _b;
      const max = (_a = checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.max) === null || _a === void 0 ? void 0 : _a.value;
      const min = (_b = checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.min) === null || _b === void 0 ? void 0 : _b.value;
    ...
    const isDisabled = vue.computed(() => {
      var _a, _b, _c;
      return isGroup.value ?
        ((_a = checkboxGroup === null || checkboxGroup === void 0 ? void 0 : checkboxGroup.disabled) === null || _a === void 0 ? void 0 : _a.value) || props.disabled || ((_b = elForm === null || elForm === void 0 ? void 0 : elForm.disabled) === null || _b === void 0 ? void 0 : _b.value) || isLimitDisabled.value :
        props.disabled || ((_c = elForm === null || elForm === void 0 ? void 0 : elForm.disabled) === null || _c === void 0 ? void 0 : _c.value);
    });
    return {
      isDisabled,
      isLimitDisabled,
  ...
  const useEvent = (props, {
    ...
    vue.watch(() => props.modelValue, val => {
      var _a;
      (_a = elFormItem === null || elFormItem === void 0 ? void 0 : elFormItem.changeEvent) === null || _a === void 0 ? void 0 : _a.call(elFormItem, val);
    });
    return {
      handleChange,
    };
  ...
  const _withId = /*#__PURE__*/ vue.withScopeId("data-v-d0387074");

  vue.pushScopeId("data-v-d0387074");
  const _hoisted_1 = /*#__PURE__*/ vue.createVNode("span", {
  ...
  script$1.render = render$1;
  script$1.__scopeId = "data-v-d0387074";
  ...
  const _withId$1 = /*#__PURE__*/ vue.withScopeId("data-v-478e906e");

  const render$1$1 = /*#__PURE__*/ _withId$1(function render(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("label", {
  ...
  script$1$1.__scopeId = "data-v-478e906e";
  script$1$1.__file = "packages/checkbox/src/checkbox-button.vue";
  ...
  var script$2 = vue.defineComponent({
    ...
    setup(props, ctx) {
      ...
      const checkboxGroupSize = vue.computed(() => props.size || elFormItemSize.value || (ELEMENT === null || ELEMENT === void 0 ? void 0 : ELEMENT.size));
      ...
      vue.provide('CheckboxGroup', Object.assign(Object.assign({
        name: 'ElCheckboxGroup',
        modelValue
      }, vue.toRefs(props)), {
        checkboxGroupSize,
  ...
  script$2.__file = "packages/checkbox/src/checkbox-group.vue";
  ...
  script$3.__scopeId = "data-v-270ef925";
  script$3.__file = "packages/tree/src/tree-node-content.vue";
  ...
  var script$4 = vue.defineComponent({
    name: 'ElTreeNode',
    components: {
      ElCollapseTransition: script,
      ElCheckbox: script$1,
      NodeContent: script$3,
    },
    props: {
      node: {
        type: Node,
  ...
  function render$4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.withDirectives((vue.openBlock(), vue.createBlock("div", {
      ...
      vue.createVNode("div", {
        ...
        vue.createCommentVNode("v-if", true),
        (_ctx.node.loading) ?
        (vue.openBlock(), vue.createBlock("span", _hoisted_1$2)) :
        vue.createCommentVNode("v-if", true),
          ...
          vue.withDirectives((vue.openBlock(), vue.createBlock("div", {
            ...
            (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.node.childNodes, (child) => {
              return (vue.openBlock(), vue.createBlock(_component_el_tree_node, {
                ...
                node: child,
                "onNode-expand": _ctx.handleChildNodeExpand
              }, null, 8 /* PROPS */ , ["render-content", "render-after-expand", "show-checkbox", "node", "onNode-expand"]))
            }), 128 /* KEYED_FRAGMENT */ ))
  ...
  script$4.__file = "packages/tree/src/tree-node.vue";
    ...
    return (vue.openBlock(), vue.createBlock("div", {
      ...
      (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.root.childNodes, (child) => {
        return (vue.openBlock(), vue.createBlock(_component_el_tree_node, {
          ...
          "show-checkbox": _ctx.showCheckbox,
          "render-content": _ctx.renderContent,
          "onNode-expand": _ctx.handleNodeExpand
        }, null, 8 /* PROPS */ , ["node", "props", "render-after-expand", "show-checkbox", "render-content", "onNode-expand"]))
      }), 128 /* KEYED_FRAGMENT */ )),
      (_ctx.isEmpty) ?
      (vue.openBlock(), vue.createBlock("div", _hoisted_1$3, [
        vue.createVNode("span", _hoisted_2$1, vue.toDisplayString(_ctx.emptyText), 1 /* TEXT */ )
      ])) :
      vue.createCommentVNode("v-if", true),
  ...
  script$5.__file = "packages/tree/src/tree.vue";
