...
export default {
    ...
    computed: {
        ...
        src(){
            if(this.isIOS()){
                return this.productData.images.split('$')[0] + '@w_375,q_80'
            } else {
                return this.productData.images.split('$')[0] + '@w_375,f_webp,q_75'
            }
        },
        canSale(){
    ...
    methods: {
        ...
        gotoDetail(e){
            let daTraceObj = {
                'level': 1,
                'position': 'product-1-' + this.posIndex,
                'content_type': '',
                'content_id': ''
            }
            this.newSak({
                daSrc: 'productItem.click',
                daAct: 'click',
                daTrace: daTraceObj
            });
...
<style lang="less-loader">
    .product-card-1x2{
        ...
        .product-info{
            ...
            .price-area{
                padding: 0px 0.10rem 0.12rem 0.10rem;
                .price{
                    color: #ff2d4b;
                    font-size: 0.36rem;
                    i{
